...
\node[dissertation small,text width=1.60cm,minimum height=10mm] (integration) at (2.10,0.50)
...
\draw[dissertation arrow] (condition.east) -- node[midway,above,font=\scriptsize,fill=white,inner sep=0.5pt]{так} (integration.west);
\draw[dissertation arrow] (condition.south) -- node[midway,right,font=\scriptsize,fill=white,inner sep=0.5pt]{ні} (stop.north);
...
\draw[dissertation arrow] (resultbus) |- node[pos=0.20,right,font=\scriptsize,fill=white,inner sep=0.5pt]{так} (full.west);
\draw[dissertation arrow] (resultbus) |- node[pos=0.20,right,font=\scriptsize,fill=white,inner sep=0.5pt]{ні} (partial.west);
\end{tikzpicture}
