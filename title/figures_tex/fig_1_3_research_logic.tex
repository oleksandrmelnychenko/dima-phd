...
\node[dissertation block,text width=5.90cm] (svs) at (-3.5,0.4) {Метод спектрально-зорового\\та структурного аналізу};
\node[dissertation block,text width=5.90cm] (beh) at (3.5,0.4) {Метод поведінкового\\узгодження ознак\\різного походження};
\node[dissertation block,text width=9.00cm] (tech) at (0,-2.8) {Інформаційна технологія виявлення аномальних кодів\\у фото- та відеооб’єктах вебресурсів};
