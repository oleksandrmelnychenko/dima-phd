...
\node[dissertation block,text width=5.2cm,minimum height=13mm] (method1) at (-3.6,1.2)
  {Метод спектрально-зорового\\та структурного аналізу};
\node[dissertation block,text width=5.2cm,minimum height=13mm] (method2) at (3.6,1.2)
  {Формалізована процедура\\поведінкового узгодження\\ознак різного походження};
...
\end{tikzpicture}
\caption{Взаємозв’язок моделі, методу, формалізованої процедури та інформаційної технології}
