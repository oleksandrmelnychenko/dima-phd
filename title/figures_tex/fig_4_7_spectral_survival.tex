...
\begin{tikzpicture}[x=1cm,y=1cm]
  ...
  \end{scope}
\end{tikzpicture}
\caption{Збереження парної спектральної відмінності після декодування кінцевих форматів (стовпці --- середні за відеоджерелами; відрізки --- 95~\% блокові інтервали повторного вибирання)}
