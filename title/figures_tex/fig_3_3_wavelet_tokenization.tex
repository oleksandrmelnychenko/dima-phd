...
\node[dissertation block,text width=4.00cm] (transforms) at (-1.80,3.00)
  {Локальні характеристики, дискретне косинусне й дискретне багатомасштабне перетворення, залишкові фільтри\\
   $X_f$};
...
\end{tikzpicture}
\caption{Формування спектральних і піксельних ознак у підтвердженій детермінованій конфігурації та межа неперевіреного розширення}
